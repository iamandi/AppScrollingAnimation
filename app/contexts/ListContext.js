...
import { type ListItemType, type CoverType } from "../types";

//import { useTabItemWidth } from "../hooks";  // ORIGINAL COMMENTED
...
const ListProvider = ({ items: listItems, cover, children }: Props) => {
  ...
  const tabItemWidth = 120; //useTabItemWidth();  // ORIGINAL COMMENTED
